	...
	<?php
      ...
      <table width="100%" class="widefat" id="straymanage">
		...
		<div>
			  ...
			  <a href="<?php echo WP_deal_ADMIN_URL; ?>&amp;ac=set"><input class="button action" type="button" value="<?php _e('Widget Setting', 'deal-or-announcement-with-countdown-timer'); ?>" /></a>
