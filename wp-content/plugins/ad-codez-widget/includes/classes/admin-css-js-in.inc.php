...
/**/
if (!class_exists ("c_ws_widget__ad_codes_admin_css_js_in"))
	{
		class c_ws_widget__ad_codes_admin_css_js_in
			{
				/*
				...
				*/
				public static function menu_pages_css ()
					{
						do_action ("ws_widget__ad_codes_before_menu_pages_css", get_defined_vars ());
						/**/
						if ($_GET["ws_widget__ad_codes_menu_pages_css"] && is_user_logged_in () && current_user_can ("edit_plugins"))
							{
								...
								/**/
								ob_start ("c_ws_widget__ad_codes_utils_css::compress_css");
								/**/
								...
								/**/
								do_action ("ws_widget__ad_codes_during_menu_pages_css", get_defined_vars ());
								/**/
								exit (); /* Clean exit. */
							}
						/**/
						do_action ("ws_widget__ad_codes_after_menu_pages_css", get_defined_vars ());
					}
				/*
				...
				*/
				public static function menu_pages_js ()
					{
						do_action ("ws_widget__ad_codes_before_menu_pages_js", get_defined_vars ());
						/**/
						if ($_GET["ws_widget__ad_codes_menu_pages_js"] && is_user_logged_in () && current_user_can ("edit_plugins"))
							{
								...
								/**/
								do_action ("ws_widget__ad_codes_during_menu_pages_js", get_defined_vars ());
								/**/
								exit (); /* Clean exit. */
							}
						/**/
						do_action ("ws_widget__ad_codes_after_menu_pages_js", get_defined_vars ());
					}
			}
	}
?>