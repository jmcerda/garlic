...
CE.Iframe.mpceEditor.hasOwnProperty("iframeElement")&&CE.Iframe.mpceEditor.iframeElement.blur();this.iframe.remove();MP.Editor.myThis.close()},"#motopress-content-editor-device-mode-preview click":function(a,c){this.hide();CE.PreviewDevice.myThis.show();CE.PreviewDevice.myThis.preview("desktop")},hide:function(){this.abortShow();this.element.addClass("motopress-ce-navbar-hide").one("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd",function(a,c){CE.Navbar.myThis.element.addClass("motopress-hide");
CE.Navbar.myThis.element.removeClass("motopress-ce-navbar-hide")})},show:function(){this.abortHide();this.element.addClass("motopress-ce-navbar-show").removeClass("motopress-hide").one("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd",function(){CE.Navbar.myThis.element.removeClass("motopress-ce-navbar-show")})},abortShow:function(){this.element.removeClass("motopress-ce-navbar-show").off("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd")},abortHide:function(){this.element.removeClass("motopress-ce-navbar-hide").off("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd")},
renderTitle:function(a){var c=this;this.$titles.each(function(){b(this).html(b(this).html().replace(new RegExp(c.hiddenCharUnicode+".*"+c.hiddenCharUnicode,"g"),c.hiddenChar+a+c.hiddenChar))})},hideContentEditor:function(){MP.Error.terminate()},showContentEditor:function(){b("html").css({overflow:"hidden",paddingTop:0});this.editorEl.siblings(':not("#'+MP.Preloader.myThis.element.attr("id")+', script, link")').each(function(){b(this).is(":hidden")||b(this).addClass("motopress-hide")});b("#wpwrap").height("100%").children("#wpcontent").children("#wpadminbar").prependTo("body");
this.editorEl.show()},showObjectControlBtns:function(){b(".motopress-object-control-btns").css("display","inline-block")},hideObjectControlBtns:function(){b(".motopress-object-control-btns").hide()},setPluginAutoOpen:function(a){sessionStorage.setItem("motopressPluginAutoOpen",a)},getPluginAutoOpen:function(){sessionStorage.getItem("motopressPluginAutoOpen")}})}(jQuery),function(b){CE.PreviewDevice=can.Control.extend({myThis:null},{mode:null,previewClassPrefix:"motopress-ce-device-mode-",init:function(a){CE.PreviewDevice.myThis=
...
typeof CE&&this.removeWpPanels();MP.Settings.getSiteUrl();MP.Settings.getWpSettings()}})}(jQuery),function(b){can.Construct("MP.Language",{},{init:function(){localStorage.clear();b.each(motopressCE.settings.translations,function(a,b){localStorage.setItem(a,b)});MP.Preloader.myThis.load(MP.Language.shortName)}})}(jQuery),function(b){CE.CodeModal=can.Control.extend({myThis:null,currentShortcode:null,currentTextareaTinymce:null,listensTo:["show","shown","hide"]},{iframeBody:null,content:null,editor:null,
saveBtn:null,saveHandler:null,isHiding:!1,editorId:"motopresscodecontent",init:function(){CE.CodeModal.myThis=this;this.container=this.element.find("#wp-"+this.editorId+"-editor-container");this.content=this.element.find("#"+this.editorId+"");"undefined"!==typeof tinyMCE&&"undefined"!==typeof tinyMCE.get(this.editorId)&&(this.editor=tinyMCE.get(this.editorId));this.saveBtn=this.element.find("#motopress-save-code-content");var a=this.element.find("#wp-"+this.editorId+"-editor-tools");0===a.height()&&
a.height(33);this.element.mpmodal({backdrop:"static",show:!1});b(window).on("resize",this.proxy("resize"));MP.Utils.addWindowFix();if(parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.0.0",">="))this.element.find(".wp-switch-editor.switch-html, .wp-switch-editor.switch-tmce").on("click",function(){CE.CodeModal.myThis.recalcTabSizeWP4()})},setSize:function(a){var b=this.element.find(".modal-footer"),d=this.element.width()-(parseFloat(b.css("padding-left"))+parseFloat(b.css("padding-right")));
b.width(d);d=this.element.find(".modal-body");b=this.element.height()-this.element.find(".modal-header").outerHeight()-parseFloat(d.css("margin-top"))-parseFloat(d.css("margin-bottom"))-b.outerHeight();d.height(b);a&&this.element.css({display:"block",visibility:"hidden"});b=parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.1.0",">=")?2:0;b=this.element.find("#wp-"+this.editorId+"-wrap").height()-this.element.find("#wp-"+this.editorId+"-editor-tools").outerHeight()-
parseFloat(this.container.css("border-top-width"))-parseFloat(this.container.css("border-bottom-width"))-b;this.container.height(b);parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.0.0","<")?this.recalcTabSizeWPOld():this.recalcTabSizeWP4();a&&(this.element.css({display:"",visibility:""}),this.content.removeAttr("rows"))},recalcTabSizeWPOld:function(){var a=this.container.height()-parseFloat(this.container.css("border-top-width"))-parseFloat(this.container.css("border-bottom-width"))-
this.element.find("#qt_"+this.editorId+"_toolbar").outerHeight()-parseFloat(this.content.css("padding-top"))-parseFloat(this.content.css("padding-bottom"));this.content.height(a);var a=this.element.find("#"+this.editorId+"_ifr"),b=this.container.find(".mce-first, tr.mceFirst").first(),d=this.container.find(".mce-statusbar, tr.mceLast").last(),b=this.container.height()-parseFloat(this.container.css("border-top-width"))-parseFloat(this.container.css("border-bottom-width"))-b.outerHeight()-d.outerHeight();
a.height(b)},recalcTabSizeWP4:function(){switch(MP.Utils.getEditorActiveMode(this.element.find("#wp-"+this.editorId+"-wrap").prop("class").split(" "))){case "html-active":var a=this.container.height()-this.element.find("#qt_"+this.editorId+"_toolbar").outerHeight()-parseFloat(this.content.css("padding-top"))-parseFloat(this.content.css("padding-bottom"));this.content.height(a);break;case "tmce-active":a=this.container.height()-parseFloat(this.container.find(".mce-toolbar-grp").outerHeight())-parseFloat(this.container.find(".mce-statusbar").outerHeight()),
this.container.find(".mce-edit-area").height(a)}},resize:function(){this.element.data("modal").isShown&&this.setSize(!1)}," show":function(a,b){this.isHiding=!1;this.switchVisual();this.setSize(!0);if(null!==this.saveHandler&&"function"===typeof this.saveHandler)this.saveBtn.off("click").on("click",this.saveHandler);null===this.iframeBody&&(this.iframeBody=this.element.find("#"+this.editorId+"_ifr").contents().find("."+this.editorId+""),this.iframeBody.css("max-width","none"));CE.Iframe.window.CE.Dialog.myThis.element.dialog("isOpen")&&
!a.data("modal").hasOwnProperty("closeDialog")&&CE.Iframe.window.CE.Dialog.myThis.element.dialog("close")}," shown":function(){null!==this.editor?this.editor.execCommand("mceFocus",!1):this.content.focus();b("body").hide(0,function(){b("body").show()})}," hide":function(a,b){if(!this.isHiding){this.isHiding=!0;var d=CE.CodeModal.currentShortcode.closest(".motopress-clmn").find("."+CE.Iframe.window.CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.Iframe.window.CE.DragDrop.myThis.dragHandle.attr("class"));
d.prev().focus();this.content.val("");null!==this.editor&&this.editor.setContent("");this.saveHandler=null;null!==CE.Iframe.mpceEditor&&CE.Iframe.mpceEditor.focus();a.data("modal").hasOwnProperty("closeDialog")&&delete a.data("modal").closeDialog;CE.Iframe.window.CE.Dialog.myThis.element.dialog("isOpen")||CE.Iframe.window.CE.Dialog.myThis.open(d);var e=setTimeout(function(){CE.CodeModal.currentShortcode=null;CE.CodeModal.currentTextareaTinymce=null;clearTimeout(e)},0)}},switchVisual:function(){var a=
MP.Utils.getEditorActiveMode(this.element.find("#wp-"+this.editorId+"-wrap").prop("class").split(" "));"undefined"!==typeof tinyMCE&&"html-active"===a&&(switchEditors.hasOwnProperty("switchto")?switchEditors.switchto(this.element.find("#"+this.editorId+"-tmce")[0]):switchEditors.go(this.editorId,"tmce"),null===this.editor&&(this.editor=tinyMCE.get(this.editorId)))}})}(jQuery),function(b){b.hasOwnProperty("fn")&&b.fn.hasOwnProperty("button")&&b.fn.button.hasOwnProperty("noConflict")&&(b.fn.btn=b.fn.button.noConflict());
new MP.Editor}(jQuery)}catch(p){MP.Error.log(p)}});
