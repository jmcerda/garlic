...
r.accordion.accordion("option","active"),r.interact("activate",e))},error:function(a){a=c.parseJSON(a.responseText);c.isPlainObject(a)&&a.hasOwnProperty("message")&&(a.debug?console.log(a.message):(parent.MP.Flash.setFlash(a.message,"error"),parent.MP.Flash.showMessage()));d.removeClass(CE.Shortcode.preloaderClass)}})}},display:function(a){this.settingsCtrl.display(a);this.stylesCtrl.display(a)}})}(jQuery),function(c){CE.Controls("CE.InlineEditor",{curElement:null,styleFormats:!1,init:function(){c(document).on("mousedown",
".mce-tinymce.mce-panel",function(a){a.preventDefault()});c(document).on("keydown",'[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]',function(a){a.which===c.ui.keyCode.TAB?CE.Selectable.myThis.unselect():a.which===c.ui.keyCode.ESCAPE&&(CE.InlineEditor.curElement&&CE.InlineEditor.curElement.control().close(!0,"show"),a=c(this).closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),
CE.Selectable.focusWithoutScroll(a.prev()),CE.Dialog.myThis.element.dialog("isOpen")||CE.Dialog.myThis.open(a))});c(parent.document).on("mousedown",function(a){CE.InlineEditor.curElement&&!c(a.target).closest(".ui-dialog").length&&CE.InlineEditor.curElement.control().close(!0,"show")})},isTinymce:function(a){var b=!1;c(a.target).hasClass("motopress-drag-handle")||(a=c(a.currentTarget.activeElement),a.length&&(a.closest("[data-motopress-shortcode]").length||a.closest(".mce-tinymce").length||a.closest(".mce-window").length||
a.closest(".mce-popover").length)&&(b=!0));return b},destroyAll:function(){var a;parent.CE.Iframe.myThis.sceneContent.find('[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]').each(function(){a=c(this).control();a.destroyEditor()})},reinitAll:function(){var a;parent.CE.Iframe.myThis.sceneContent.find('[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]').each(function(){a=c(this).control();a.initEditor()})}},{id:null,isOpen:!1,editor:null,helpers:null,
blockContent:null,floatpanel:null,saved:!1,init:function(a,b){this._super(a,b);this.id=parent.MP.Utils.uniqid();this.blockContent=this.element.parent("."+CE.DragDrop.myThis.blockContent.attr("class"));var c=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first();this.helpers=c.add(c.children().not(".motopress-splitter, .motopress-clmn-select-handle"));this.resizers=this.blockContent.nextAll(".ui-resizable-handle");c.children("."+CE.DragDrop.myThis.dragHandle.attr("class")).on("click",
this.proxy("onClick"))},destroy:function(){CE.InlineEditor.curElement=null;this.floatpanel&&this.floatpanel.remove();this._super()},initEditor:function(){var a=this,b=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),d=setTimeout(function(){var e="bold italic underline | ";c.isEmptyObject(CE.InlineEditor.styleFormats)||(e+="styleselect | ");tinyMCE.init({selector:"#"+a.id,inline:!0,plugins:"link hr textcolor",
visual:!1,convert_urls:!1,menubar:!1,toolbar:e+"formatselect | fontsizeselect forecolor | alignleft aligncenter alignright alignjustify | numlist bullist outdent indent | link unlink hr removeformat",fontsize_formats:"8px 9px 10px 11px 12px 13px 14px 15px 16px 18px 24px 30px 36px 42px 48px 60px 72px 96px",language:parent.MP.Settings.lang.tinymce,skin:"motopresscontenteditor",browser_spellcheck:parent.MP.Settings.spellcheck,style_formats_merge:!1,style_formats:CE.InlineEditor.styleFormats,setup:function(d){a.editor=
