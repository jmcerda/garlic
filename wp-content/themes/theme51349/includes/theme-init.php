...
if ( ! function_exists( 'my_setup' ) ):
	function my_setup() {
		...
		if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
			...
			add_image_size( 'slider-post-thumbnail', 1170, 440, true ); // Slider Thumbnail
...
function my_post_type_portfolio() {
	register_post_type( 'portfolio',
		array( 
				'label'             => __('Gallery', CURRENT_THEME),
...
/* Products */
function my_post_type_products() {
...
add_action('init', 'my_post_type_products');
