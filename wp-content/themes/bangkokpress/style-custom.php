...
div.custom-sidebar .recent-post-widget-comment-num{display:none; background: url('<?php echo GOODLAYERS_PATH; ?>/images/icon/<?php echo $gdl_icon_type; ?>/comment.png') no-repeat 0px 0px; }
