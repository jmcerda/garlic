...
<div id="footer-text" class="footer-text">
	...
	<?php if( is_front_page() ) { ?>
		More Travel Agency WordPress Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/travel-agency-wordpress-themes/" target="_blank">TemplateMonster.com</a>
	<?php } ?>
</div>